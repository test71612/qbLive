 ...
 * here (or in the GitHub Action in docs/dep-graph.yml) keeps the whole thing
 * on free tiers.
 *
 * Usage:
 *   node scripts/generate-dep-graph.mjs --dir ../streamer-platform --repo owner/name
 *   node scripts/generate-dep-graph.mjs --dir . --repo owner/name --out graph.json
 *
